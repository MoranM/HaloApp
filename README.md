...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-halo-app.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-halo-app)

This repository contains the source code for the [Halo](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.halo.app).

Please see the [issues](https://github.com.halo.app/com-halo-app/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Halo? Ask away on the [com-halo-app discussion forum](https://groups.google.com/forum/#!forum/com-halo-app).

<a href="https://play.google.com/store/apps/details?id=com.halo.app" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.halo.app__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.halo.app__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.halo.app.R__) will now be renamed
...
signed with a different key.  Manually uninstall Halo from your device and
...
Halo is a result of a template project I've developed over the years as well as
...
Halo is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.halo.app/com-halo-app/contributors) on
...
[pull requests](https://github.com.halo.app/com-halo-app/pulls).
